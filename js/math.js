...
const Mat33 = {
  ...
  // Note: UNIT must be passed in or assumed to be 36 based on context.
  // In the original, it relied on a global UNIT variable.
  // To make it pure, we could pass it or default it, but let's look at the original definition.
  getTransformMatrix: (x, y, r, sx, offX, offY, UNIT = 36) => {
...
if (typeof module !== 'undefined' && module.exports) {
  ...
  // Export for browser (if using global scope)
  // Assuming it's loaded via <script> tag
